...
<head>
    ...
    <link id="color-link" rel="stylesheet" text/css" href="{{ asset('assets/css/demo4.css') }}">
    <style>
        .h-logo {
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{ route ('app.index')}}" class="nav-link menu-title">Cart</a></li>
                                            <li><a href="{{ route ('app.index')}}" class="nav-link menu-title">About Us</a></li>
                                            <li><a href="{{ route ('app.index')}}" class="nav-link menu-title">Contact Us</a>
                                            </li>
                                          ...
                                          @if(Route::has('login'))
                                                    @auth
                                                       @if (Auth::user()->utype=== 'ADM')
                                                           <li>
                                                                <a href="{{ route('admin.index') }}" class="d-block">Dasboard</a>
                                                           </li>
                                                        @else
                        ...
                        <div class="footer-contact">
                            <div class="brand-logo">
                                <a href="index.htm" class="footer-logo float-start">
                                    <img src="asset{{asset('assets/images/logo.png') }}" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo">
                                </a>
                            </div>
